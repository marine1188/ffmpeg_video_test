<?php
    ...
    $command_string = "ffmpeg -i /var/www/html/web_csk/SmartFashion/video_file/".$vido_name." -an -ss 00:00:00 -qscale 1 -r $frames_num -y /var/www/html/web_csk/SmartFashion/video_frame/".$vido_name_cut."_%5d.png 2>&1";
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     <br>
       <img width="200" heigh="100" src="/web_csk/SmartFashion/video_frame/<?=$vido_name_cut?>_00001.png" alt="">
       <img width="200" heigh="100" src="/web_csk/SmartFashion/video_frame/<?=$vido_name_cut?>_00002.png" alt="">
